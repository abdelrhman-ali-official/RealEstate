...
{
    public class PropertyWithDeveloperSpecifications : Specifications<Property>
    {
        public PropertyWithDeveloperSpecifications(int id) : base(property => property.Id == id)
        {
            AddInclude(property => property.Developer);
            AddInclude(property => property.Developer.User);
            AddInclude(property => property.Broker);
        }

        public PropertyWithDeveloperSpecifications(PropertySpecificationsParameters parameters)
            : base(property =>
